...
var Categoria = function () {
    var _classDecorators = [(0, typeorm_1.Entity)({ name: "tb_categorias" })];
    ...
    var Categoria = _classThis = /** @class */ (function () {
        function Categoria_1() {
            ...
            this.descricao = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _descricao_initializers, void 0));
    ...
    (function () {
        ...
        _descricao_decorators = [(0, class_validator_1.IsNotEmpty)(), (0, typeorm_1.Column)({ length: 255, nullable: false })];
